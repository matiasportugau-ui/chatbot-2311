...
from simulate_chat import SimulatedChat, API_URL, MONGODB_URI
...
class KnowledgeBasePopulator:
    ...
    def load_scenarios(self, scenarios_dir: str = "test_scenarios") -> List[Dict[str, Any]]:
        ...
        for file_path in files:
            try:
                ...
                print(f"✅ Loaded {len(file_scenarios) if isinstance(file_scenarios, list) else 1} scenarios from {os.path.basename(file_path)}")
    ...
    def run_scenario(self, scenario: Dict[str, Any], verbose: bool = True) -> Dict[str, Any]:
        ...
        if verbose:
            ...
            print(f"   Messages: {results['messages_successful']}/{results['messages_sent']} successful")
        
        return results
    
    def populate(self, scenarios_dir: str = "test_scenarios", verbose: bool = True) -> Dict[str, Any]:
...
def main():
    ...
    parser.add_argument('--scenarios', '-s', default='test_scenarios',
