...
class SistemaCompletoBMC:
        ...
        try:
            ...
            for codigo_producto, datos_producto in matriz_precios['productos'].items():
                if 'espesores_disponibles' in datos_producto:
                    ...
                    self.sistema_cotizaciones.actualizar_precio_producto(codigo_producto, Decimal(str(precio_base)))
    ...
    def buscar_cotizaciones(self):
        ...
        if opcion == "1":
            ...
            telefono = input("Teléfono: ").strip()
            resultados = self.sistema_cotizaciones.buscar_cotizaciones_por_cliente(telefono=telefono)
        elif opcion == "3":
    ...
    def mostrar_estadisticas(self):
        ...
        if total_cotizaciones > 0:
            ...
            # Precio promedio
            precios = [float(c.precio_total) for c in self.sistema_cotizaciones.cotizaciones if c.precio_total > 0]
            if precios:
