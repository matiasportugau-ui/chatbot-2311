...
class EnvironmentValidator:
            ...
            self.errors.append(
                {
                    ...
                    "fix": "Create .env file from env.example: cp env.example .env",
                }
            )
            return False
    ...
    def _generate_nextauth_secret(self) -> str | None:
    ...
    def print_report(self, result: dict[str, Any]):
        ...
        print(
            f"Optional variables: {'✅ Valid' if summary['optional_valid'] else '⚠️  Some issues'}"
        )
        print("=" * 70 + "\n")
