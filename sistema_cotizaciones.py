...
class SistemaCotizacionesBMC:
    ...
    def calcular_precio_cotizacion(
        self, especificaciones: EspecificacionCotizacion
    ...
    def buscar_cotizaciones_por_cliente(
        self, nombre: str = "", telefono: str = ""
    ) -> list[Cotizacion]:
    ...
    def buscar_cotizaciones_por_fecha(
        self, fecha_inicio: datetime.datetime, fecha_fin: datetime.datetime
    ) -> list[Cotizacion]:
