...
from language_processor import Intent, get_language_processor
    ...
    def _procesar_informacion_mejorada(self, processed, cliente_id: str, sesion_id: str):
        ...
        if entities.get("products"):
            ...
            return self.ia_base.procesar_mensaje(
                f"informacion sobre {product}", cliente_id, sesion_id
            )
...
if __name__ == "__main__":
    ...
    result = processor.process_message(
        "Hola, necesito cotizar Isodec 100mm para 50m2", session_id="test_session_1"
    )
