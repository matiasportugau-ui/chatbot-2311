...
def demo_conversacion_completa():
    ...
    cliente = Cliente(
        nombre="Gabriel", telefono="099123456", direccion="Montevideo", zona="Montevideo"
    )
...
def demo_multiples_cotizaciones():
    ...
    espec1 = EspecificacionCotizacion(
        "isodec", "100mm", "EPS", Decimal("8.0"), Decimal("4.0"), "Blanco"
    )
    ...
    print(
        f"Dimensiones: {cot1.especificaciones.largo_metros}m x {cot1.especificaciones.ancho_metros}m"
    )
    ...
    espec2 = EspecificacionCotizacion(
        "isodec", "75mm", "EPS", Decimal("6.0"), Decimal("3.0"), "Blanco"
    )
    ...
    print(
        f"Dimensiones: {cot2.especificaciones.largo_metros}m x {cot2.especificaciones.ancho_metros}m"
    )
    ...
    espec3 = EspecificacionCotizacion(
        "isodec", "100mm", "EPS", Decimal("12.0"), Decimal("6.0"), "Gris"
    )
    ...
    print(
        f"Dimensiones: {cot3.especificaciones.largo_metros}m x {cot3.especificaciones.ancho_metros}m"
    )
...
def demo_busqueda_cotizaciones():
    ...
    for i, (nombre, telefono, direccion) in enumerate(clientes):
        ...
        espec = EspecificacionCotizacion(
            "isodec", "100mm", "EPS", Decimal("5.0"), Decimal("3.0"), "Blanco"
        )
