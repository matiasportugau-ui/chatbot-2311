...
class AutomatedAgentSystem:
    ...
    def __init__(self, ia_instance: Any | None = None):
        """
        ...
        self.monitoring: AgentMonitoring | None = None

        # Agent instances
        self.followup_agent: FollowUpAgent | None = None
        self.proactive_actions: ProactiveAgentActions | None = None
    ...
    def initialize(self):
        ...
        try:
            ...
            self.followup_agent = FollowUpAgent(
                coordinator=self.coordinator, ia_instance=self.ia_instance
            )
...
def main():
    ...
    parser.add_argument("--ia", action="store_true", help="Enable IA integration")
