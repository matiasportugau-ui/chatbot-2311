        ...
        try:
            ...
            if not ia.base_conocimiento:
                self.reporte["errores"].append({
                    ...
                    "error": "Base de conocimiento no inicializada"
                })
                return False
            ...
            if respuesta and respuesta.mensaje:
                ...
                print(f"  ✅ IA conversacional funcionando")
    ...
    def validar_productos(self) -> bool:
        ...
        try:
            ...
            if productos_faltantes:
                self.reporte["errores"].append({
                    "tipo": "productos",
                    "error": f"Productos faltantes: {productos_faltantes}"
                })
    ...
    def validar_respuestas_usando_conocimiento(self) -> bool:
        ...
        try:
            ...
            if respuestas_mejoradas >= len(preguntas_test) * 0.5:  # Al menos 50%
                ...
                print(f"  ⚠️  Solo {respuestas_mejoradas}/{len(preguntas_test)} respuestas mejoradas")
                return False
