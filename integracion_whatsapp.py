...
class IntegracionWhatsApp:
    ...
    def registrar_interaccion_whatsapp(
        self, phone: str, name: str, mensaje: str, respuesta: str, message_id: str
    ):
        ...
        try:
            ...
            print("✅ Interacción registrada en base de conocimiento")
    ...
    def simular_mensaje_whatsapp(self, phone: str, name: str, message: str):
        ...
        self.registrar_interaccion_whatsapp(
            ...
            message,
            respuesta.mensaje,
            f"sim_{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}",
        )
...
def main():
    ...
    for mensaje in mensajes_simulados:
        whatsapp.simular_mensaje_whatsapp(mensaje["phone"], mensaje["name"], mensaje["message"])
        print()
