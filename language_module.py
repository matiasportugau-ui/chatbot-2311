...
class LanguageManager:
    ...
    def __init__(self, locale: str = "es", locales_dir: str | None = None):
        """
    ...
    def _get_translation(self, locale: str, namespace: str, key: str) -> str | None:
    ...
    def t(self, key: str, namespace: str = "common", **kwargs) -> str:
        ...
        if not translation:
            print(
                f"Warning: Translation missing for key '{key}' in namespace '{namespace}' (locale: {self.locale})"
            )
            return key
...
_global_language_manager: LanguageManager | None = None
