...
class WorkflowEngine:
    ...
    def __init__(
        self, coordinator: AgentCoordinator | None = None, router: AgentRouter | None = None
    ):
        """
    ...
    def _create_followup_workflow(self) -> WorkflowDefinition:
        ...
        steps = [
            WorkflowStep(
                ...
                config={"task_type": "check_conversation", "required_capabilities": ["follow_up"]},
            ...
            WorkflowStep(
                ...
                config={"task_type": "generate_followup_message", "use_ai": True},
            ...
            WorkflowStep(
                ...
                config={"task_type": "send_message", "channel": "whatsapp"},
    ...
    def _create_quote_workflow(self) -> WorkflowDefinition:
        ...
        steps = [
            WorkflowStep(
                ...
                config={"task_type": "validate_quote_data"},
            ...
            WorkflowStep(
                ...
                config={"task_type": "request_missing_data"},
                next_steps=[],
            ),
            WorkflowStep(
    ...
    def execute_workflow(self, workflow_id: str, initial_data: dict[str, Any] = None) -> str:
        ...
        thread = threading.Thread(
            target=self._execute_workflow_thread, args=(execution,), daemon=True
        )
        thread.start()
    ...
    def _get_step_by_id(self, workflow: WorkflowDefinition, step_id: str) -> WorkflowStep | None:
        """Get step by ID"""
    ...
    def _get_next_step(
        self, step: WorkflowStep, execution: WorkflowExecution, result: Any
    ) -> str | None:
...
def get_workflow_engine(
    coordinator: AgentCoordinator | None = None, router: AgentRouter | None = None
) -> WorkflowEngine:
