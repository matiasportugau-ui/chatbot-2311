...
class ProactiveAgentActions:
    ...
    def schedule_quote_followups(self):
        ...
        try:
            ...
            logger.info(
                f"Scheduled quote follow-ups: {len(quotes_24h)} (24h), {len(quotes_48h)} (48h), {len(quotes_72h)} (72h)"
            )
    ...
    def _schedule_quote_followup(self, quote: dict[str, Any], interval: str):
        ...
        try:
            ...
            self.quotes.update_one(
                {"_id": quote["_id"]}, {"$set": {f"followup_{interval}_scheduled": True}}
            )
    ...
    def _recover_abandoned_cart(self, conversation: dict[str, Any]):
        ...
        try:
            ...
            self.conversations.update_one(
                ...
                {
                    "$set": {
                        "abandoned_recovery_sent": True,
                        "abandoned_recovery_at": datetime.now().isoformat(),
                    }
                },
            )
    ...
    def _generate_recovery_message_ai(self, conversation: dict[str, Any]) -> str:
        ...
        try:
            ...
            prompt = (
                "Genera un mensaje de recuperación de carrito abandonado. "
                "El cliente empezó una cotización pero no la completó. "
                "El mensaje debe ser amigable, no intrusivo, y ofrecer ayuda. "
                "Máximo 3 líneas."
            )
    ...
    def recommend_products(self, conversation: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        try:
            ...
            if mentioned_products:
                ...
                recommendations.append(
                    {"product": "isodec", "reason": "Producto más popular", "confidence": 0.6}
                )
...
_proactive_actions_instance: ProactiveAgentActions | None = None
...
def get_proactive_actions(
    ...
    if _proactive_actions_instance is None:
        _proactive_actions_instance = ProactiveAgentActions(
            coordinator, scheduler, workflow_engine, ia_instance
        )
